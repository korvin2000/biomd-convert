...
Spans: {{rowspanCount}} rowspan, {{colspanCount}} colspan. Grid fill: {{gridFill}}.
...
{{#columnWidths}}
Measured column widths (px): {{.}}.
{{/columnWidths}}
{{^columnWidths}}
Column widths: NOT MEASURED — the page was not rendered, so treat layout cues as weak.
{{/columnWidths}}
{{#corpusFrequency}}
This structure appears on {{.}} of corpus pages.
{{/corpusFrequency}}
{{#caption}}
Caption: {{.}}.
{{/caption}}
